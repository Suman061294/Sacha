    ...
    return (
        <nav className="absolute top-[40px] left-0 w-full bg-transparent py-4 z-50">
            ...
            <div className="max-w-[1300px] mx-auto px-6 lg:px-20 flex items-center justify-between">
                ...
                {/* Desktop Menu */}
                <div className="hidden md:flex items-center gap-8 text-white font-medium font-space text-lg">
                    <Link href="/" className="hover:text-[#224936]">Home</Link>

                    {/* Dropdown */}
                    <div className="relative">
                        <button
                            onClick={() => setDropdown(!dropdown)}
                            className="hover:text-[#224936]"
                        >
                            Shop By Category ▾
                        </button>
                    ...
                    <Link href="/blog" className="hover:text-[#224936]">Blog</Link>
                    <Link href="/contact" className="hover:text-[#224936]">Contact Us</Link>
                </div>
