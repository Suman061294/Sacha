...
export default function Section4() {
  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-[600px] px-4 sm:px-6 flex flex-col justify-between">
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-7xl grid grid-cols-[300px_1fr_300px] items-center">
            {/* Left side */}
            <motion.div style={{ rotate: leftRotate }} className="flex flex-col items-start">
              <Image
                src="/product/s1.png"
                alt="Product"
                width={350}
            ...
            {/* Right side */}
            <motion.div style={{ rotate: rightRotate }} className="flex items-center justify-center">
              <Image
                src="/product/s2.png"
                alt="Product"
                width={350}
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-[300px_1fr_300px] items-end mb-0">
          <div>
            <p className="raf text-[#224936] text-xl sm:text-3xl md:text-3xl leading-tight">
              In Hindi,
            </p>
      ...
      <div className="relative min-h-[500px] px-4 sm:px-6 flex items-center justify-center">
      ...
      <div className="relative min-h-[400px] bg-[#FDA71B] px-4 sm:px-6 overflow-x-hidden">
        <div className="grid grid-cols-[400px_1fr_400px] items-start h-full max-w-7xl mx-auto">
          ...
          <div className="max-w-[500px] flex flex-col items-start justify-center space-y-6">
            ...
            <p className="text-xl text-white fractul-light mt-10">
              Well, fun fact:<br />
          ...
          <div className="max-w-[500px] flex flex-col items-start justify-center space-y-6">
            <p className="text-3xl text-white fractul-light">
              A blend of <em className="fractul-medium">organically<br />grown</em> and mindfully<br />
      ...
      <div className="flex-1 flex items-center justify-center h-[800px]">
        <div className="w-full max-w-7xl grid grid-cols-[500px_1fr_500px] items-center">
          {/* Left side */}
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[#224936] text-xl fractul-light">No Chemicals</span>
              </div>

              {/* Item 2 */}
              <div className="flex items-center space-x-2 my-6">
                <IoMdClose className="w-16 h-16 text-[#FF1E3C]" />
                <span className="text-[#224936] text-xl fractul-light">No artificial<br /> flavouring</span>
              </div>

              {/* Item 3 */}
              <div className="flex items-center space-x-2">
                <IoMdClose className="w-16 h-16 text-[#FF1E3C]" />
                <span className="text-[#224936] text-xl fractul-light">No shortcuts</span>
              </div>
          </motion.div>
