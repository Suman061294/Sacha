  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center space-y-2 z-10">
        ...
        <div className="relative">
          <h1
            className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-widest relative z-20 fractul-medium"
            style={{
          ...
          >
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-widest fractul-medium">
              HOLISTICS
            </h1>
          </motion.div>
        </div>
